...
> [!done]- Propose an implementation of a failure detector and discuss its properties (completeness and accuracy) in a synchronous distributed system
...
>   
> In an asynchronous system this detector will lack of accuracy because message delays are unbounded and it's not possible to be certain about a process death.
