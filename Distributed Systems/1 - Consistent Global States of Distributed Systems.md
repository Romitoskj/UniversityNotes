...
>[!Important] Definition
>**Clock Condition:** $e \rightarrow e' \Rightarrow TS(e) < TS(e')$
...
---
## Logical Clocks
In an synchronous system no global real-time clock can exist, but other mechanisms can be used to satisfy the clock condition.
