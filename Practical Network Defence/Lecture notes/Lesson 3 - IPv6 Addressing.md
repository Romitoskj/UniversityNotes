...
- **The "3-1-4" Rule:** Instead of Variable Length Subnet Masks, IPv6 GUA standardizes a `/64` prefix length for most physical networks. A typical address features 3 hexets for the Global Routing Prefix, 1 hexet for the Subnet ID, and 4 hexets for the **Interface ID** (the host portion).
  ![](images/Pasted%20image%2020260316184705.png)

- **Generating the Interface ID (both for GUA and Link-Local):**
